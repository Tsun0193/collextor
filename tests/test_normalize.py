...
class NormalizeTests(unittest.TestCase):
    ...
    def test_malicious_html_stripped_from_description(self):
        article = canonicalize_article({"title": "Clean title", "url": "https://example.com/a", "published_at": "2026-01-01T00:00:00Z", "description": "<img src=x onerror=alert(1)>Hello<script>x</script>"}, SOURCE, "2026-01-01T00:00:00Z")
    ...
    def test_deduplication_by_url_and_title_similarity(self):
        ...
        a = canonicalize_article({"title": "OpenAI releases a new multimodal model", "url": "https://example.com/a?utm_medium=x", "published_at": fetched}, SOURCE, fetched)
        b = canonicalize_article({"title": "OpenAI releases new multimodal model", "url": "https://example.com/a?utm_campaign=y", "published_at": fetched}, SOURCE, fetched)
